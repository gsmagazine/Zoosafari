...
static NSString * const kZoosafariJavascript = @"Ti.App={};Ti.API={};Ti.App._listeners={};Ti.App._listener_id=1;Ti.App.id=Ti.appId;Ti.App._xhr=XMLHttpRequest;"
...
-(NSString*)_zoosafariInjection
{
	...
	[html appendString:kZoosafariJavascript];
...
{
	// attempt to make well-formed HTML and inject in our Zoosafari bridge code
	...
	if (range.location!=NSNotFound)
	{
		...
		if (nextRange.location!=NSNotFound)
		{
			...
			[html appendString:[self _zoosafariInjection]];
