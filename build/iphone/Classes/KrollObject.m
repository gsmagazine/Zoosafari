 ...
 * Copyright (c) 2009-2012 by Zoosafari, Inc. All Rights Reserved.
...
//@interface ZoosafariObject : NSObject
//@end

@interface ZoosafariObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[ZoosafariObject class]])
		{
			for (NSString *key in [[(ZoosafariObject*)o modules] allKeys])
			{
