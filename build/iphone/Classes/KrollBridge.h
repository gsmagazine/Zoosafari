...
@interface ZoosafariObject : KrollCoverageObject {
#else
@interface ZoosafariObject : KrollObject {
#endif
@private
...
extern NSString * Zoosafari$ModuleRequireFormat;
