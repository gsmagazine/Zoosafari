...
/**
 Base class for all Zoosafari views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Zoosafari view hierarchy (such as wrapped iOS UIViews) was touched.
