...
// in simulator we redefine to format for Zoosafari Developer console
...
{\
	NSString * exceptionName = [@"org.zoosafari." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.zoosafari";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIZoosafariNativeItemNone = -1, 
	UIZoosafariNativeItemSpinner = -2,
	UIZoosafariNativeItemProgressBar = -3,
	
	UIZoosafariNativeItemSlider = -4,
	UIZoosafariNativeItemSwitch = -5,
	UIZoosafariNativeItemMultiButton = -6,
	UIZoosafariNativeItemSegmented = -7,
	
	UIZoosafariNativeItemTextView = -8,
	UIZoosafariNativeItemTextField = -9,
	UIZoosafariNativeItemSearchBar = -10,
	
	UIZoosafariNativeItemPicker = -11,
	UIZoosafariNativeItemDatePicker = -12,
	
	UIZoosafariNativeItemInfoLight = -13,
	UIZoosafariNativeItemInfoDark = -14,
	
	UIZoosafariNativeItemDisclosure = -15,
	
	UIZoosafariNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Zoosafari instances of
